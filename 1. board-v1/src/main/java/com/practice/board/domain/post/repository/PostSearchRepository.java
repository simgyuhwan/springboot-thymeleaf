...
public class PostSearchRepository {
    ...
    public Page<Posts> findAllBySearchDto(SearchDto postSearchDto, Pageable pageable){
    ...
    private TypedQuery<Posts> getQuery(SearchDto postSearchDto, Pageable pageable, String jpql) {
